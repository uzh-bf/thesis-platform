  ...
  return (
    ...
    >
      <div className="relative overflow-hidden bg-[#0028A5] shadow-sm sm:rounded-lg">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-y-0 -right-7 flex items-center opacity-[0.18] sm:right-3 sm:opacity-75 md:right-4 lg:right-8"
        >
          <Image
            ...
            height={256}
            priority
            className="h-36 w-36 sm:h-16 sm:w-16 md:h-20 md:w-20 lg:h-24 lg:w-24 xl:h-28 xl:w-28 2xl:h-32 2xl:w-32"
          />
        </div>

        <div className="relative px-4 py-5 sm:px-8 sm:pr-24 md:px-10 md:py-6 md:pr-28 lg:pr-40 xl:pr-44 2xl:pr-48">
          <div className="max-w-3xl">
            <h1
              id="df-community-banner-heading"
              className="text-balance text-xl font-semibold leading-[1.12] tracking-tight text-white md:text-2xl"
            >
